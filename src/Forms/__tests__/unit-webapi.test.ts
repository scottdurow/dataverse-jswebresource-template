...
const TEST_STRING = ["'abc!\"£$%^&*()?<> test string 1", "\"abc!'£$%^&*()?<> test string 2"];
/*
Demonstrates how to create a simple unit test that mocks the Xrm.WebApi
by setting mock implementations that are chained
*/
