...
export const contactMetadata = {
  ...
  attributeTypes: {
    ...
    adx_partnernumberofemployees: "Integer",
    adx_partneryearsofrelevantexperience: "Decimal",
    ...
    adx_partner_applicationstatus: "Optionset",
    adx_partnercontactrole: "Optionset",
    ...
    adx_partner_anniversarydate: "DateOnly:DateOnly",
    adx_partner_applicationdate: "DateOnly:DateOnly",
...
export const enum ContactAttributes {
  ...
  adx_Competencies = "adx_competencies",
  ...
  adx_geo_apac = "adx_geo_apac",
  adx_geo_australia = "adx_geo_australia",
  adx_geo_emea = "adx_geo_emea",
  adx_geo_northamerica = "adx_geo_northamerica",
  adx_geo_southamerica = "adx_geo_southamerica",
  ...
  adx_Interestedinpartnerenrollment = "adx_interestedinpartnerenrollment",
  ...
  adx_partner_accountcreated = "adx_partner_accountcreated",
  adx_partner_anniversarydate = "adx_partner_anniversarydate",
  adx_partner_applicationdate = "adx_partner_applicationdate",
  adx_partner_applicationstatus = "adx_partner_applicationstatus",
  adx_partner_applicationsubmitted = "adx_partner_applicationsubmitted",
  adx_partner_targetmarket = "adx_partner_targetmarket",
  adx_partner_technologies = "adx_partner_technologies",
  adx_PartnerContactRole = "adx_partnercontactrole",
  adx_PartnerKeyReferences = "adx_partnerkeyreferences",
  adx_PartnerNumberOfEmployees = "adx_partnernumberofemployees",
  adx_PartnerYearsofRelevantExperience = "adx_partneryearsofrelevantexperience",
...
export interface Contact extends IEntity {
  ...
  // Partner Competencies MemoType Partner Competencies
  adx_competencies?: string | null;
  ...
  // Created By (portal contact) LookupType Unique identifier for Contact associated with Contact.
  ...
  // Asia/Pacific BooleanType
  adx_geo_apac?: boolean | null;
  // Australia BooleanType
  adx_geo_australia?: boolean | null;
  // Europe, Middle East, Africa BooleanType
  adx_geo_emea?: boolean | null;
  // North America BooleanType
  adx_geo_northamerica?: boolean | null;
  // South America BooleanType
  adx_geo_southamerica?: boolean | null;
  ...
  // Interested in partner enrollment? BooleanType
  adx_interestedinpartnerenrollment?: boolean | null;
  ...
  // Partner Account Created BooleanType
  adx_partner_accountcreated?: boolean | null;
  // Partner Anniversary Date DateTimeType DateOnly:DateOnly
  adx_partner_anniversarydate?: Date | null;
  // Partner Application Date DateTimeType DateOnly:DateOnly
  adx_partner_applicationdate?: Date | null;
  // Partner Application Status contact_adx_contact_adx_partner_applicationstatus
  adx_partner_applicationstatus?: import("../enums/contact_adx_contact_adx_partner_applicationstatus").contact_adx_contact_adx_partner_applicationstatus | null;
  // Partner Application Submitted BooleanType
  adx_partner_applicationsubmitted?: boolean | null;
  // Target Market/customer MemoType
  adx_partner_targetmarket?: string | null;
  // Technologies coverage MemoType
  adx_partner_technologies?: string | null;
  // Partner Contact Role adx_partnercontactroles
  adx_partnercontactrole?: import("../enums/adx_partnercontactroles").adx_partnercontactroles | null;
  // Partner Key References StringType
  adx_partnerkeyreferences?: string | null;
  // Partner Number of Employees IntegerType
  adx_partnernumberofemployees?: number | null;
  // Partner Years of Relevant Experience DecimalType
  adx_partneryearsofrelevantexperience?: number | null;
